...
//    decode = {
//      if (typeTag != "di") {
//        throw Osc.Message.Converter.Error("typeTag must be 'di', but was: '$typeTag'")
//      }
//      Foo(
//        bar = double(),
//        buzz = int()
...
//
//    }
//    osc.route<Int>("/int2") { value ->
//      // TODO set atomic integer here
//    }
//    osc.flow<Int>("/int3") { value ->
//
//    }
